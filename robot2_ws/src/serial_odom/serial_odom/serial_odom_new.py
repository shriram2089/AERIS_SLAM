...
class SerialOdomNode(Node):
    ...
    def timer_callback(self):
        ...
        tf_msg.header.frame_id = f'{ns}/odom'
        tf_msg.child_frame_id = f'{ns}/base_footprint'
    ...
    def publish_static_transforms(self):
        ...
        tf1.header.frame_id = f'{ns}/base_footprint'
        tf1.child_frame_id = f'{ns}/base_link'
        tf1.transform.rotation.w = 1.0

        tf2 = TransformStamped()
        tf2.header.stamp = now
        tf2.header.frame_id = f'{ns}/base_link'
        tf2.child_frame_id = f'{ns}/laser_frame'
        tf2.transform.translation.z = 0.2
        tf2.transform.rotation.w = 1.0

        tf3 = TransformStamped()
        tf3.header.stamp = now
        tf3.header.frame_id = f'{ns}/base_link'
        tf3.child_frame_id = f'{ns}/imu_link'
