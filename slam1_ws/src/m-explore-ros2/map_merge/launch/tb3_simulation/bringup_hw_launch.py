...
def generate_launch_description():
    ...
    my_params_path = "/home/pi/slam_ws/src/m-explore-ros2/map_merge/launch/tb3_simulation/config/nav2_multirobot_params_1_final.yaml"
    ...
    ld.add_action(DeclareLaunchArgument(
        ...
        description="Custom Nav2 params file for robot1"
    ))
    ...
    nav_group = GroupAction([
        PushRosNamespace(namespace),  # all nodes under robot1
    ...
    gmapping_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "remap_tf": ["/tf", "/robot1/tf"],
            "remap_tf_static": ["/tf_static", "/robot1/tf_static"],
        }.items(),
    )
