...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument("namespace", default_value="robot2", description="Robot namespace"))
    ...
    ld.add_action(DeclareLaunchArgument("params_file",
        default_value=os.path.join(launch_dir_map_merge, "config", "nav2_multirobot_params_2.yaml"),
